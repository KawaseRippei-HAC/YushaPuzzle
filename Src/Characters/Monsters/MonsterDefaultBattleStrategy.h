#ifndef CHARACTERS_MONSTERS_MONSTER_DEFAULT_BATTLE_STRATEGY_H_
#define CHARACTERS_MONSTERS_MONSTER_DEFAULT_BATTLE_STRATEGY_H_
...
// モンスターのデフォルト戦闘クラス
class MonsterDefaultBattleStrategy final : public IBattleActor {
public:
	// コンテキスト
	explicit MonsterDefaultBattleStrategy(CharacterBase* monster);
	// デストラクタ
	~MonsterDefaultBattleStrategy() = default;
...
private:
	CharacterBase* monster_;
};

#endif // CHARACTERS_MONSTERS_MONSTER_DEFAULT_BATTLE_STRATEGY_H_
